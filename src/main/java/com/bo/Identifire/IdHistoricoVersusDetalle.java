 ...
 */
@Embeddable
public class IdHistoricoVersusDetalle implements Serializable {
    private static final long serialVersionUID = -32607237202485824L;
    ...
    public IdHistoricoVersusDetalle() {super();}

    public IdHistoricoVersusDetalle(Integer id_versus, Integer id_jugador, Integer id_curso, Integer id_pregunta, Integer id_respuesta) {
